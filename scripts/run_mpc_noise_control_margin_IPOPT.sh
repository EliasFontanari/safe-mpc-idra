...
NOISE=("5.0" "3.7" "2.5" "1.3" "0.1")
#ALPHA_ARG=("10" "20" "30" "40" "50")
ALPHA_ARG=("20")
#HORIZON_ARG=("15" "20" "25" "30" "35" "40" "45" "50")
HORIZON_ARG=("45")

# MARGIN_JOINTS=("0.1" "2.6" "5" "10" )
# MARGIN_COLLISION=("0.005" "0.01" "0.02" "0.03" )
MARGIN_JOINTS=("0.1" "1.3" "2.6" "5" "10" "15")
MARGIN_COLLISION=("0.002" "0.004" "0.006" "0.008" "0.01" "0.012")


LOG_METRICS="results_mpc_with_noise_"$1"_hor_"$2"_alpha_"$3"_IPOPT.txt"
> "$LOG_METRICS"
