...
for i in range(n_samples):
    ...
    sampled_states[i, model.nq:] = velocity_direction_normalized *np.array(set_OCP.safe_set.pure_nn_output(sampled_states[i])).squeeze()  # fix this to sample on the border of the set
